...
#  sorular 191.....200 arası 10 soru...tkinter modundadır...

#  sorular iman, ibadet ve ahlak konularındandır...
...
questions = [
    ...
    {"q": "11. Namaz günde kaç vakittir?",
     "a": ["3", "4", "5", "6"], "c": 2},

    {"q": "12. Abdestin farzlarından biri hangisidir?",
     "a": ["Ayakları yıkamak", "Niyet etmek", "Yüzü yıkamak", "Dua okumak"], "c": 2},

    {"q": "13. Oruç hangi ayda farz kılınmıştır?",
     "a": ["Şaban", "Recep", "Ramazan", "Muharrem"], "c": 2},

    {"q": "14. Zekât kimlere verilmez?",
     "a": ["Fakirlere", "Borçlulara", "Anne ve babaya", "Yolda kalmışlara"], "c": 2},

    {"q": "15. Hac ibadeti hangi şehirde yapılır?",
     "a": ["Medine", "Kudüs", "Mekke", "Taif"], "c": 2},

    {"q": "16. İsraf ne anlama gelir?",
     "a": ["Tasarruf", "Paylaşmak", "Gereksiz harcamak", "Sabretmek"], "c": 2},

    {"q": "17. Gıybet nedir?",
     "a": ["Yalan söylemek", "Birini arkasından kötülemek", "Küfür etmek", "Tartışmak"], "c": 1},

    {"q": "18. Anne-babaya saygının hükmü nedir?",
     "a": ["Sünnet", "Vacip", "Farz", "Mekruh"], "c": 2},

    {"q": "19. Sabır neyi ifade eder?",
     "a": ["Korkmak", "Zorluklara dayanmak", "Susmak", "Kaçmak"], "c": 1},

    {"q": "20. Yalan söylemenin hükmü nedir?",
     "a": ["Caiz", "Mekruh", "Haram", "Vacip"], "c": 2},
]

# ------------------ TKINTER PENCERE ------------------

root = tk.Tk()
root.title("İslami Test - İman, İbadet ve Ahlak")
...
def show_result():
    ...
    if score >= 15:  # 20 sorudan en az 15 doğru
        play_success_animation()
        messagebox.showinfo("SONUÇ", f"{score}/20 🎉 GEÇTİN")
    else:
        messagebox.showwarning("SONUÇ", f"{score}/20 ❌ KALDIN")
...
#  1.ci soru... İmanın şartları kaç tanedir?
...
#  & "C:\Users\USER\Islamı_Test_Soruları/.venv/Scripts/python.exe" islami_test_python_23.py



# python3 "/home/ismail/Documents/Python/gtk-dersi/data/İslami Test/Soruları/islami_test_python_23.py" pardusda

#  & "C:\Users\USER\Islamı_Test_Soruları/.venv/Scripts/python.exe" islami_test_python_23.py  windows da
