...
def play_beep(frequency, duration):
    ...
    if sys.platform == 'win32':
        ...
        # Linux/Mac için sistem bip sesi
        print('\a', end='', flush=True)
...
def play_success_animation():                                    # başarı animasyonu fonksiyonu
    ...
    anim.after(5000, anim.destroy)      # 5 saniye sonra pencereyi kapat
...
#  çalışıyor ..... tesşekkürler......sonuna kadar gitmedim ama güzel görünüyor...
...
#  & "C:\Users\USER\Islamı_Test_Soruları/.venv/Scripts/python.exe" islami_test_python_37.py



#  & "E:/İslami Test Soruları/.venv/Scripts/python.exe" islami_test_python_37.py           Pardusda

# python3 "/home/ismail/Documents/Python/gtk-dersi/data/İslami Test/Soruları/islami_test_python_37.py" pardusda

#  & "C:\Users\USER\Islamı_Test_Soruları/.venv/Scripts/python.exe" islami_test_python_37.py      windows da


# 01 DEN 100 E KADAR İLERLEYEN SORULAR VAR...SONUNDA BAŞARI DURUMU VE SERTİFİKA ALMA VAR ...SES YOK..ANİMASYON YOK

#  bu test teki sorular önceki ile aynı fakat bunda '' TEBRİKLER '' EKRANI ÇIKIYOR......
