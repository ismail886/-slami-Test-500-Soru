...
def show_result():
    ...
    if score >= 6:  # 10 sorudan en az 6 doğru
...
#  1.ci sorudan başlıyor... İmanın şartları kaç tanedir?
...
#  & "C:\Users\USER\Islamı_Test_Soruları/.venv/Scripts/python.exe" islami_test_python_24.py


# python3 "/home/ismail/Documents/Python/gtk-dersi/data/İslami Test/Soruları/islami_test_python_24.py" pardusda
